# semaphores are advanced counters.
# An acquire() call to a semaphore will block
# only after a number of threads have acquire()ed it. 
# The associated counter decreases per acquire() 
# call, and increases per release() call.
